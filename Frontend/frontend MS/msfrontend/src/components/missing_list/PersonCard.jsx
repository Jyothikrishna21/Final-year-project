...
//     const response = await fetch(`http://localhost:3000/api/missingpeople/deleteperson/${id}`, {
//       method: 'DELETE',
  ...
  const deletethis = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:3000/api/missingpeople/deleteperson/${id}`,
        {
          method: "DELETE",
        }
      );
      ...
      if (response.ok) {
        toast.success(`Person with Aadhar number ${id} deleted successfully`, {
          position: "top-right",
          autoClose: 3000,
        ...
        const newCases = props.totalcases.filter(
          (noteelement) => noteelement.adhaar_number !== id
        );
        props.changecase(newCases);
      } else {
        ...
        <div className="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
          ...
          <div className="flex flex-col px-6">
            ...
            <div className="mt-2 flex flex-row items-center space-x-5">
              ...
              >
                <img
                  src="https://img.icons8.com/material-outlined/24/000000/calendar-13.png"
                  width="20px"
                />
              ...
              >
                <img
                  src="https://img.icons8.com/external-outline-agus-raharjo/64/000000/external-height-healthcare-outline-agus-raharjo.png"
                  width="30px"
                />
              ...
              >
                <img
                  src="https://img.icons8.com/external-parzival-1997-detailed-outline-parzival-1997/64/000000/external-identification-touchless-society-parzival-1997-detailed-outline-parzival-1997.png"
                  width="30px"
                />
